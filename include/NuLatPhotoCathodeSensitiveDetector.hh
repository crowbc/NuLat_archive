...
// ********************************************************************
//
// $Id: NuLatPhotoCathodeSensitiveDetector.hh 76474 2013-11-11 10:36:34Z gcosmo $
//
/// \file NuLatPhotoCathodeSensitiveDetector.hh
/// \brief Definition of the NuLatPhotoCathodeSensitiveDetector class

#ifndef NuLatPhotoCathodeSensitiveDetector_h
#define NuLatPhotoCathodeSensitiveDetector_h 1
...
class NuLatPhotoCathodeSensitiveDetector : public G4VSensitiveDetector
{
    
public:
    NuLatPhotoCathodeSensitiveDetector(G4String name,
    ...
    virtual ~NuLatPhotoCathodeSensitiveDetector();
...
private:
    NuLatPhotoCathodeHitsCollection* PhotoCathodeHitCollection;
    G4int PhotoCathodeHitCollectionID;
